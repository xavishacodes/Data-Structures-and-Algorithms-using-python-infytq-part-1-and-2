...
# The current items in the library are:
...
# The new items after sorting based on the author name are:
# Look Ahead
# E.M.Freddy
# 2012
# Innocent in Death
...
# The final set of items after adding the new item list are:
# A Mission In Kashmir
# Andrew Whitehead
# 1995
# A Passage of India
...
# The items sorted based on the increasing order of their published year:
# A Mission In Kashmir
# Andrew Whitehead
# 1995
# A pair of blue eyes
