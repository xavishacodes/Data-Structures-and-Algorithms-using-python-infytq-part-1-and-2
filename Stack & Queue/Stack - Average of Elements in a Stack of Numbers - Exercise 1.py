...
#         print("The Stack is Empty. Can't find average")
#     else:
#         i=num_list.get_max_size()-1
#         sum=0
#         while i>=0:
#             sum+=num_list[i]
#             i+=1
