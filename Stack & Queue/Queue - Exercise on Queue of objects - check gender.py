...
# check_gender (people_queue, gender) :

# Here, people_queue represents a queue of people. Each person is identified by their name, age and gender. This method should create and return a new queue with the people belonging to the specified gender.

# Note:

# 1. The new queue should have the same size as that of the people_queue.

# 2. Perform case-sensitive comparison wherever applicable.
...
class People:
    ...
    def check_gender(people_queue,gender):
        ...
        while not(people_queue.is_empty()):
            data=people_queue.dequeue()
            if(data.get_gender()==gender):
