...
# Problem Statement
# Given a queue of integers, write a python program to split it into two queues, one containing odd numbers and another even numbers. The relative order of elements must be maintained.
