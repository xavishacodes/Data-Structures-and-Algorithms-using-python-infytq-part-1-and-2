...
# __init__(children_list)

#  Initializes the children list

# change_position(child)

#  Used to change the position of the child passed as the argument to the middle position
...
class Performance:
    ...
    def change_position(self,child):
        ...
        next_node=self.__children_list.get_head()
        while temp.get_next():
            next_node=next_node.get_next()
            if temp.get_next().get_next():
                temp=temp.get_next().get_next()
        self.__children_list.delete(child)
        self.__children_list.insert(child,next_node.get_data())
